    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                <input style="height:48px;width:150px;float:right" type="button" class="btn btn--radius-2 btn--blue" onclick='location.href="login.php"' value="Login" />
                    ...
                    <form action="" name="registration" method="post" class="signin-form" enctype="multipart/form-data"> 
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" name="signup" type="submit" style="float:right">Submit</button>
