					...
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							<div class="text w-100">
								...
								<a href="../index.php" class="btn btn-white btn-outline-white">Home</a>
							</div>
			      </div>
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form action="" name="login" method="post" class="signin-form" enctype="multipart/form-data"> 

			      		<div class="form-group mb-3">
			      			<label class="label" for="name">Username</label>
			      			<input type="text" name="uemail" class="form-control" placeholder="Username" required>
			      		</div>
		            <div class="form-group mb-3">
